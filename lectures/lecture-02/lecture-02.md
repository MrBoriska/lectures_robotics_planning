...
## Лекция 02: [Название темы будет предоставлено]
...
<!-- _header: "Интерактивная практика | Лекция 02" -->

## Интерактивная демонстрация: Исследование алгоритма <span class="badge badge-green">⏱️ 55–70 мин</span>

<div class="interactive-container">
  <div class="interactive-header">
    <span><i class="interactive-dot"></i> Интерактивный симулятор: Сэмплирующие алгоритмы RRT / RRT*</span>
