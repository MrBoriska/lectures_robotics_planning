...
<div class="text-sm mt-2" style="color: #64748b; font-style: italic;">
*Примечание: Формулы приведены для демонстрации физической сложности процессов. Для планирования достаточно понимать лишь качественную суть явлений.*
</div>
...
- **Лекция 04:** Кинематические модели и выборочные методы с моделью движения (DWA, MPPI)
...
- **Лекция 07:** Динамические ограничения и профилирование скорости (сцепление, TOPP-RA, State Lattice)
